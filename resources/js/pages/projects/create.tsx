...
export default function ProjectsCreate({ vendors, allClients }: { vendors: { id: number; name: string }[]; allClients: ClientOption[] }) {
    ...
    const submit: FormEventHandler = (e) => {
        ...
        if (clientMode === 'new') {
            ...
            payload.client_id = clientMode === 'existing' ? data.client_id : '';
            delete payload.new_client;
        }
        post(route('projects.store'), {
            data: payload as typeof data,
            forceFormData: true,
        });
    };
                ...
                <form onSubmit={submit} className="space-y-4">
                    ...
                    <Card className="max-w-2xl">
                        <CardHeader>
                            ...
                            <CardDescription>Invite client ke proyek ini (opsional). Hanya client dari vendor yang sama.</CardDescription>
                        </CardHeader>
